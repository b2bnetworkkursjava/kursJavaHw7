...
public class Plane {
    ...
    public Plane (int planeId, String model, double capacity, String type, Pilot pilot, Passenger passenger, int noOfSeats) {
    ...
    public void setmMdel (String model) {this.model = model;}
